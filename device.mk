...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/mixer_paths.txt:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_holi/mixer_paths.xml \
    $(LOCAL_PATH)/audio/mixer_paths.txt:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.xml \
